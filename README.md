...
```
# Day 15
Today I have learned something more about functions and access specifiers ( private, public, external, and internal ) also learn about gas cost and pure and view function(read-only function) that does not cost any gass fee.
```
